...
class IpBillingNew extends StatefulWidget {
  @override
  _IpBillingNewState createState() => _IpBillingNewState();
}

class _IpBillingNewState extends State<IpBillingNew> {
